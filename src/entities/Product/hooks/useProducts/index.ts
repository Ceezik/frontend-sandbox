...
const fetchProducts = async (params: {
  ...
  const { data } = await axios.get<{ products: Array<Product>; count: number }>(
    "/products",
    {
      params,
    }
  ...
  return {
    ...data,
    nextPage:
      params.start + params.count < data.count
  ...
  return useInfiniteQuery(
    ...
    ({ pageParam }) =>
      fetchProducts({
        ...
        tags: props.tags,
        search:
          props.search && props.search.trim().length ? props.search : undefined,
      }),
    {
